...
public class Utilisateur implements Serializable,UserDetails {
	...
	public Utilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue,
			String codePostal, String ville, String motDePasse, String confirmMotDePasse, Integer credit,
			boolean administrateur, List<ArticleVendu> achats, List<ArticleVendu> ventes, List<Enchere> enchères) {
		super();
		this.pseudo = pseudo;
		this.nom = nom;
		this.prenom = prenom;
	...
	public Utilisateur(Integer noUtilisateur, String pseudo, String nom, String prenom, String email, String telephone,
			String rue, String codePostal, String ville, String motDePasse, String confirmMotDePasse, Integer credit,
			boolean administrateur, List<ArticleVendu> achats, List<ArticleVendu> ventes, List<Enchere> enchères) {
		super();
